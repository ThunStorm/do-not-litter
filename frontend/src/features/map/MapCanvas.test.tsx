...
describe('AmapLayer lifecycle', () => {
  it('keeps one map instance while data, selection, and viewport change', async () => {
    ...
    const props = { clusters: [], selectedId: null, onSelect: vi.fn(), onReady: vi.fn(), onViewportChange: vi.fn(), onDraftLocation: vi.fn() }
