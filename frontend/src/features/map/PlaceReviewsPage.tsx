...
import { ArrowLeft, Check, MapPin, MapPinCheck, Pencil, RotateCcw, X } from 'lucide-react'
import { useState } from 'react'
import { Link } from 'react-router-dom'

import { api } from '../../lib/api'

type Candidate = { provider_id: string; name: string; address: string; city: string; district: string; typecode: string; score: number; match_reasons: string[]; match_explanation?: { nearby_context?: string[]; cross_place_context?: string[] } }
