...
type Insight = { id: string; insight_type: string; value_text: string }
...
export function PlaceDetailPage() {
  ...
  useEffect(() => setNote((place.data as Detail | undefined)?.note?.markdown ?? ''), [place.data])
