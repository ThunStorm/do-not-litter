...
> 已归档（2026-09-08）：本计划的地图稳定化、地点管理和时间证据工作已由 `77e37eb` 与 `161d320` 覆盖。当前实现与未闭环项见 [实施状态](../../IMPLEMENTATION_STATUS.md)；比较托盘、推荐与自动路线已转入 [Future Roadmap](../../planning/FUTURE_ROADMAP.md)。
...
> 原建议落库路径：`dev docs/planning/PLACE_MAP_STABILIZATION_AND_TRAVEL_DECISION_PLAN.md`（现归档于本目录）
