...
class AINoteSection(Base):
    ...
    section_kind: Mapped[str] = mapped_column(String(32), default="SUPPLEMENTAL", nullable=False)
    ...
    place_mention_ids_json: Mapped[list] = mapped_column(JSON, default=list, nullable=False)
    evidence_quotes_json: Mapped[list] = mapped_column(JSON, default=list, nullable=False)
